...
#include "./model/SparkFun_mnist.h"
...
int main(int argc, char* argv[]) {
  ...
  error_reporter->Report("Parsing MNIST classifier model FlatBuffer called [%s], size [%d] bytes.", model_tflite_name, model_tflite_len);
  ...
  error_reporter->Report("MNIST classifier completed successfully.\n");
