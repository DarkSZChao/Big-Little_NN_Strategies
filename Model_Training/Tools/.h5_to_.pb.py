...
tf.disable_v2_behavior()  # enable TF v1.x in v2.x environment
...
if __name__ == "__main__":
    FLAGS.input_model = os.path.join(ROOTS_Tools.output_model_path, 'multi_motions_s3.h5')
    FLAGS.output_model = os.path.join(ROOTS_Tools.output_model_path, 'multi_motions_s3.pb')
    app.run(main)
