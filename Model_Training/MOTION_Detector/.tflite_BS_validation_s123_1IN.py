...
if __name__ == '__main__':
    ...
    single_motion_0 = os.path.join(ROOTS.MOTION_Detector_output_model_path, 'Best_model_-128127/single_motion_0.tflite')
    single_motion_1 = os.path.join(ROOTS.MOTION_Detector_output_model_path, 'Best_model_-128127/single_motion_1.tflite')
    single_motion_2 = os.path.join(ROOTS.MOTION_Detector_output_model_path, 'Best_model_-128127/single_motion_2.tflite')
    single_motion_3 = os.path.join(ROOTS.MOTION_Detector_output_model_path, 'Best_model_-128127/single_motion_3.tflite')
    single_motion_4 = os.path.join(ROOTS.MOTION_Detector_output_model_path, 'Best_model_-128127/single_motion_4.tflite')
    single_motion_5 = os.path.join(ROOTS.MOTION_Detector_output_model_path, 'Best_model_-128127/single_motion_5.tflite')
