...
#define TENSOR_CONV1D_KERNEL_0 {-53, -74, -52, -2, 57, -5, 57, 29, 62, 85, -58, -6, -1, -24, -24, 22, -42, 28, 11, 55, -19, 19, 26, 18, 40, 53, 24, -18, 124, 26, -36, -15, 8, 1, -21, -27}

#define TENSOR_CONV1D_KERNEL_0_DEC_BITS {7}

#define TENSOR_CONV1D_BIAS_0 {45, -42, 63, -30}
...
#define TENSOR_CONV1D_1_KERNEL_0 {-3, 92, -28, 36, -40, 39, 34, 84, -57, -7, -37, 10, 52, -65, -52, 22, 52, 25, 11, 12, 42, 27, 19, -50, 7, 48, -15, 52, 36, -28, -48, -22, 69, -8, 9, -17, 34, -71, -18, -15, 37, 12, -36, 5, -89, -53, -33, 64}

#define TENSOR_CONV1D_1_KERNEL_0_DEC_BITS {7}

#define TENSOR_CONV1D_1_BIAS_0 {-65, 105, 40, -66}
...
#define TENSOR_CONV1D_2_KERNEL_0 {32, -27, 34, 14, -29, 57, -60, -98, -27, -7, 12, -23, 42, 0, -15, -27, -24, -36, -27, -13, 12, -90, -24, 107}

#define TENSOR_CONV1D_2_KERNEL_0_DEC_BITS {7}

#define TENSOR_CONV1D_2_BIAS_0 {-18, -42}
...
#define TENSOR_DENSE_KERNEL_0 {33, 44, -24, 33, -33, 49, -60, 35, -10, 8, -31, 51, 15, 56, 0, 85, -50, 54, -14, 36, 1, 72, -54, 73, -26, 87, -19, 82, -9, 47, -23, 8, -33, -43, -1, -44, 8, -9, -35, -43, 2, -51, -1, -46, 53, -45, 59, -39, 3, -56, 46, -53, 36, -14, 14, -8, 29, -9, 38, -23, 35, -61, -11, -25}

#define TENSOR_DENSE_KERNEL_0_DEC_BITS {7}

#define TENSOR_DENSE_BIAS_0 {126, -126}
...
#define CONV1D_2_OUTPUT_DEC 0
#define CONV1D_2_OUTPUT_OFFSET 0
#define RE_LU_2_OUTPUT_DEC 0
#define RE_LU_2_OUTPUT_OFFSET 0
#define MAX_POOLING1D_2_OUTPUT_DEC 0
